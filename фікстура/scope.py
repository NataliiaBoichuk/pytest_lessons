...
#
# a1: фикстура с областью действия function (function-scoped fixture) и
# параметром autouse = True: экземпляр этой фикстуры будет создан до создания остальных function-scoped фикстур.
#
